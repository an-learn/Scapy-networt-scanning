...
def ips():
	...
	ips_list_h = []			# "-" hyphen
	ips_list_c = []			# "," comma
	ips_input = raw_input("[scanning-ACK] IP > ")
	if ips_input == "bk":
		print"===========================\n"
		main.select_port()
	elif ips_input == "exit":
...
def ports():
	...
	ports_list_h = []			# "-" hyphen
	ports_list_c = []			# "," comma
	ports_input = raw_input("[scanning-ACK] Port > ")
	if ports_input == "bk":
		print"===========================\n"
		main.select_port()
...
def ports_scan_start():
	global ip,result,ports_list_cc
	...
	for ip in ips_list_c:
		...
		for s in range(1,1000):
			...
			if not sorted(ports_list_cc) == sorted(result):
				...
				break
		print("IP:\n ["+ip+"]")
		print("Unfiltered Port("+str(len(list(set(ports_list_c)-set(result))))+"/"+str(len(ports_list_c))+"):")
		print (" "+str(sorted(list(set(ports_list_c)-set(result)))))
		print("Filtered Port("+str(len(result))+"/"+str(len(ports_list_c))+"):")

...
def select():
	answer3 = raw_input("[discovery-OBA] Select > ")
	if answer3 == "1.1":
		list_ips()
		ips1()
	elif answer3 == "1.2":
...
def ips1():
	...
	ips_list_h = []			# "-" hyphen
	ips_list_c = []			# "," comma
	ips_input = raw_input("[discovery-OBA] IP > ")
	if ips_input == "bk":
		print"===========================\n"
		select()
	elif ips_input == "exit":
...
def ips1_c(ic):
	answer1 = sr1(IP(dst = ips_list_c[ic])/ICMP(),timeout=1,verbose=0)
	answer2 = sr1(IP(dst = ips_list_c[ic])/TCP(dport=80,flags="S"),timeout=1,verbose=0)
	answer3 = sr1(IP(dst = ips_list_c[ic])/TCP(dport=445,flags="S"),timeout=1,verbose=0)
	answer4 = sr1(IP(dst = ips_list_c[ic])/TCP(dport=24242,flags="S"),timeout=1,verbose=0)
	answer5 = sr1(IP(dst = ips_list_c[ic])/TCP(dport=80,flags="A"),timeout=1,verbose=0)
	answer6 = sr1(IP(dst = ips_list_c[ic])/TCP(dport=445,flags="A"),timeout=1,verbose=0)
	answer7 = sr1(IP(dst = ips_list_c[ic])/TCP(dport=2222,flags="A"),timeout=1,verbose=0)
	answer8 = sr1(IP(dst = ips_list_c[ic])/TCP(dport=80,flags="SA"),timeout=1,verbose=0)
	answer9 = sr1(IP(dst = ips_list_c[ic])/TCP(dport=445,flags="SA"),timeout=1,verbose=0)
	answer10 = sr1(IP(dst = ips_list_c[ic])/TCP(dport=24242,flags="SA"),timeout=1,verbose=0)
	answer11 = sr1(IP(dst = ips_list_c[ic])/UDP(dport=53),timeout=1,verbose=0)
	answer12 = sr1(IP(dst = ips_list_c[ic])/UDP(dport=33333),timeout=1,verbose=0)
	answer13 = sr1(IP(dst = ips_list_c[ic])/UDP(dport=33333),timeout=1,verbose=0)
	if (answer1 == None and answer2 == None and answer3 == None
	and answer4 == None and answer5 == None and answer6 == None
	and answer7 == None and answer8 == None and answer9 == None
	and answer10 == None and answer11 == None and answer12 == None
	and answer13 == None):
		pass
	else:
		print(ips_list_c[ic]+"\n")
...
def iptxt_start():
	filename = raw_input("[discovery-OBA] Filename > ")
	if filename == "bk":
		print"===========================\n"
		select()
	elif filename == "exit":
